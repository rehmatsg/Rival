...
import 'package:e/screens/add_sponsor.dart';
      ...
      body: ListView(
        children: [
          ListTile(
            ...
            onTap: () => Navigator.of(context).push(RivalNavigator(page: MyPartners()))
          ),
          if (me.isBusinessAccount) ListTile(
            title: Text('Manually Approve Partners'),
            subtitle: Text('Enabling this will make people send you a request before adding you as a sponsor'),
              ...
              onChanged: (val) async {
                await Loader.show(
                  ...
                  function: () async {
                    ...
                    await me.update({
                      'manuallyApprovePartnerRequests': val
                    }, reload: true);
                  },
                  onComplete: () {
                    setState(() { });
          ...
          if (me.isBusinessAccount && (me.manuallyApprovePartnerRequests || me.partnerRequests.isNotEmpty)) ListTile(
            title: Text('Requests'),
            subtitle: Text('Approve or deny business partner requests'),
            onTap: () => Navigator.of(context).push(RivalNavigator(page: PartnerRequests()))
          ),
          ListTile(
            title: Text('Add Partner'),
            subtitle: Text('Add business accounts as your partner for sponsored posts'),
            onTap: () => Navigator.of(context).push(RivalNavigator(page: AddSponsor()))
          ),
          if (me.isBusinessAccount) Padding(
