              ...
              child: Card(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Tooltip(
                        message: 'People who viewed your post for atleast 2 seconds',
                        child: Row(
                      ...
                      Divider(),
                      Tooltip(
                        message: 'Number of times your post appeared in other\'s timeline',
                        child: Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: [
                            Row(
                              ...
                              children: [
                                ...
                                Text('Reach', style: TextStyle(fontFamily: RivalFonts.feature, fontSize: Theme.of(context).textTheme.headline6.fontSize),),
                              ],
                            ),
                            Text(post.reach.length.toString(), style: TextStyle(fontSize: Theme.of(context).textTheme.bodyText1.fontSize),)
                          ],
                        ),
                      ),
                      Divider(),
                      ...
                      Divider(),
                      Tooltip(
                        message: 'Number of people who liked your post',
                        child: Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: [
                            Row(
