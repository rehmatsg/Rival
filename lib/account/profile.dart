            ...
            children: [
                  ...
                  children: [
                    GestureDetector(
                      ...
                      child: Container(
                        ...
                        child: Column(
                          children: [
                            Text('Posts', style: Theme.of(context).textTheme.subtitle2.copyWith(
                              color: MediaQuery.of(context).platformBrightness == Brightness.light ? Colors.grey[900] : Colors.grey[500]
                            ),),
                            Text(NumberFormat.compact().format(user.posts.length), style: Theme.of(context).textTheme.headline5.copyWith(fontFamily: RivalFonts.feature),),
                          ],
                        ),
                      ),
                    ),
                    GestureDetector(
                      ...
                      child: Container(
                        ...
                        child: Column(
                          children: [
                            Text('Followers', style: Theme.of(context).textTheme.subtitle2.copyWith(
                              color: MediaQuery.of(context).platformBrightness == Brightness.light ? Colors.grey[900] : Colors.grey[500]
                            ),),
                            Text(NumberFormat.compact().format(user.followers.length), style: Theme.of(context).textTheme.headline5.copyWith(fontFamily: RivalFonts.feature),),
                          ],
                        ),
                      ),
                    ),
                    GestureDetector(
                      ...
                      child: Container(
                        ...
                        child: Column(
                          children: [
                            Text('Following', style: Theme.of(context).textTheme.subtitle2.copyWith(
                              color: MediaQuery.of(context).platformBrightness == Brightness.light ? Colors.grey[900] : Colors.grey[500]
                            ),),
                            Text(NumberFormat.compact().format(user.following.length), style: Theme.of(context).textTheme.headline5.copyWith(fontFamily: RivalFonts.feature),),
                          ],
                        ),
                      ),
                    ),
              ...
              if (user.bio != null) Padding(
                ...
                child: Column(
                  ...
                  mainAxisSize: MainAxisSize.min,
                  children: [
                    if (user.bio.length <= 120) TextParser(
                    ...
                    else if (user.bio.length > 120) ExpandablePanel(
                      ...
                      collapsed: GestureDetector(
                        ...
                        child: RichText(
                          text: TextSpan(
                            children: <TextSpan>[
                              TextSpan(text: '${user.bio.toString().substring(0, 120).replaceAll('\n', ' ').trim()}... ', style: Theme.of(context).textTheme.bodyText2,),
              ...
              if (!isCurrentUser) Padding(
                ...
                child: Row(
                  children: [
                    ...
                    if (user.showContactCall && user.isBusinessAccount) Flexible(
                      fit: FlexFit.tight,
                      child: Padding(
                        padding: const EdgeInsets.symmetric(horizontal: 3),
                        child: OutlinedButton(
                    ...
                    if (user.showContactEmail && user.isBusinessAccount) Flexible(
                      fit: FlexFit.tight,
                      child: Padding(
                        padding: const EdgeInsets.symmetric(horizontal: 3),
                        child: OutlinedButton(
          ...
          builder: (context, snapshot) {
            if (snapshot.connectionState == ConnectionState.done) {
              ...
              if (user.private && !user.isFollowing && user.uid != me.uid) {
                ...
                return Stack(
                  children: [
                    if (post.items.indexWhere((item) => item.type == PostType.image) < 0) Container( // This condition is true when the post only conatins poll and no images
                      width: double.infinity,
                      height: double.infinity,
                      color: Colors.indigoAccent,
                      child: Center(
                        child: Text('Poll', style: TextStyle(color: Colors.white, fontFamily: RivalFonts.feature),)
                      ),
                    ) else OctoImage(
